...
module BranchTargetBuffer(
    ...
    input wire [`BTB_INDEX_WIDTH-1: 0] write_index [`COMMIT_SIZE],
    input wire [`BTB_TAG_WIDTH-1: 0] read_tag [`IF_GROUP_SIZE],
    input wire [`BTB_TAG_WIDTH-1: 0] write_tag [`COMMIT_SIZE],
    input BranchType write_type [`COMMIT_SIZE],
    input wire [`INST_ADDR_WIDTH-1: 0] tar_addr_in [`COMMIT_SIZE],
